...
function MonsterMaker({ location }) {
    ...
    useEffect(() => {
        ...
        axios.get('http://54.82.71.40:5000/api/colours')
            .then(response => {
        ...
        axios.get('http://54.82.71.40:5000/api/body')
            .then(response => {
        ...
        axios.get('http://54.82.71.40:5000/api/feet')
            .then(response => {
                setMonsterParts(prevState => ({
                    ...prevState,
        ...
        axios.get('http://54.82.71.40:5000/api/eyes')
            .then(response => {
                setMonsterParts(prevState => ({
                    ...prevState,
        ...
        // Fetch mouth SVG
        axios.get('http://54.82.71.40:5000/api/mouth')
            .then(response => {
                setMonsterParts(prevState => ({
                    ...prevState,
        ...
        axios.get('http://54.82.71.40:5000/api/back')
            .then(response => {
                setMonsterParts(prevState => ({
                    ...prevState,
        ...
        axios.get('http://54.82.71.40:5000/api/tail')
            .then(response => {
                setMonsterParts(prevState => ({
                    ...prevState,
        ...
        axios.get('http://54.82.71.40:5000/api/arms')
            .then(response => {
                setMonsterParts(prevState => ({
                    ...prevState,
        ...
        axios.get('http://54.82.71.40:5000/api/randomname')
            .then(response => {
